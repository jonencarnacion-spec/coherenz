...
// Ported from React Bits (reactbits.dev) "Scanner" component -- another
// approach-hero background option, alongside Galaxy. Shader/render logic is
// unmodified from the source; only typed for this project's TS conventions
// and given brand-navy default colors instead of the source's violet/pink.
...
const directionToFloat = (dir: string) => (dir === 'horizontal' ? 1.0 : dir === 'diagonal' ? 2.0 : 0.0);
...
const Scanner = ({
  // Brand-navy defaults (source shipped violet/pink/white) -- deep navy base,
  // a lighter blue for the interference bands, white for the signal peaks.
  color1 = '#1A2744',
  color2 = '#2E5077',
  color3 = '#FFFFFF',
  speed = 0.5,
  ...
  useEffect(() => {
    ...
    (u.uColor1.value as Float32Array)[0] = c1[0];
    (u.uColor1.value as Float32Array)[1] = c1[1];
    (u.uColor1.value as Float32Array)[2] = c1[2];
    (u.uColor2.value as Float32Array)[0] = c2[0];
    (u.uColor2.value as Float32Array)[1] = c2[1];
    (u.uColor2.value as Float32Array)[2] = c2[2];
    (u.uColor3.value as Float32Array)[0] = c3[0];
    (u.uColor3.value as Float32Array)[1] = c3[1];
    (u.uColor3.value as Float32Array)[2] = c3[2];
