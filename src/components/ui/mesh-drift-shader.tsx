// ShaderBackground -- a single WebGL canvas that fills its parent, adapted
// from a pasted 21st.dev "Shader Builder" (mesh drift) snippet into this
// project's conventions rather than copied verbatim:
// - Dropped the Next.js "use client" directive -- meaningless in this
//   Astro/Vite project and not used by any other component here (see
//   blur-reveal.tsx).
// - Recolored UNIFORMS.colors from the source's electric blue/cyan/white
//   (off-palette -- DESIGN.md has no cyan) to Coherenz's navy/blue/green
//   trio. Also deliberately excludes orange/yellow: DESIGN.md reserves the
//   red-orange-yellow gradient for the monogram/watermark only, never a
//   UI/section background, so this stays within the "sober" half of the
//   palette (navy, blue, green) instead.
// - Reduced brightness/intensity slightly from the source defaults so the
//   white serif quote text this sits behind (services/[slug].astro's
//   pull-quote section) keeps enough contrast without a separate overlay.
...
const UNIFORMS = {
  // Coherenz navy/blue/green -- see file-header comment. Values are
  // #1A2744, #2E5077, #174E40, #1A2744 (repeats to close the loop) as
  // 0..1 floats, in place of the source's electric blue/cyan/white.
  colors: [
    [0.1019607843, 0.1529411765, 0.2666666667],
    [0.1803921569, 0.3137254902, 0.4666666667],
    [0.0901960784, 0.3058823529, 0.2509803922],
    [0.1019607843, 0.1529411765, 0.2666666667],
    [0.1019607843, 0.1529411765, 0.2666666667],
    [0.1019607843, 0.1529411765, 0.2666666667],
    [0.1019607843, 0.1529411765, 0.2666666667],
