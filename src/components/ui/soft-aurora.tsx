...
// Ported from React Bits (reactbits.dev) "SoftAurora" component -- the
// fourth approach-hero background option tried this session (after Galaxy,
// Scanner, and Threads). Shader/render logic is unmodified from the source;
// only typed for this project's TS conventions and given brand-navy/blue
// default colors instead of the source's white/magenta.
...
export default function SoftAurora({
  ...
  scale = 1.5,
  brightness = 1.0,
  // Brand navy/blue defaults (source shipped white/magenta).
  color1 = '#2E5077',
  color2 = '#5FD8FF',
  noiseFrequency = 2.5,
  noiseAmplitude = 1.0,
